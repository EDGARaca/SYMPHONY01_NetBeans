<%-- 
    ...
    Created on : 28/07/2025, 10:51:49 p. m.
    Author     : Spiri
--%>

<%@page import="java.util.List"%>
<%@page import="com.mycompany.SYMPHONY01_NetBeans.Estudiante"%>
...
<html>
    <head>
        ...
        <title>Sistema de Información Academica SYMPHONY - SIAS - Modificar Estudiante</title>
    </head>
    <body>
       <div class="container">
   <%
