<%-- 
    ...
    Created on : 28/07/2025, 9:47:39 p. m.
    Author     : Spiri
--%>
...
<html>
    <head>
        ...
        <title>Sistema de Información Academica SYMPHONY SIAS - Nuevo Estudiante</title>
    </head>
                            <%
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            <input type="hidden" name="action" value="actualizar">
                             <div class="col">
                                <label>Nombres</label>
                                <input type="text" name="nombre"  class="form-control" placeholder="Digite los nombres del estudiante" required>
                              </div>
                            <div class="col">
                                <label>
                                    Apellidos
                                </label>
                                <input type="text" name="apellido"  class="form-control" placeholder="Digite los apellidos del estudiante" required>
                            </div>
                            <div class="col">
